...
_G.packer_plugins = {
  ...
  catppuccin = {
    loaded = true,
    path = "/Users/andrea/.local/share/nvim/site/pack/packer/start/catppuccin",
  ...
  ["nvim-treesitter-context"] = {
    loaded = true,
    path = "/Users/andrea/.local/share/nvim/site/pack/packer/start/nvim-treesitter-context",
  ...
  ["which-key.nvim"] = {
    ...
    loaded = true,
    path = "/Users/andrea/.local/share/nvim/site/pack/packer/start/which-key.nvim",
